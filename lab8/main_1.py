...
def function(x):
    if x == 0:
        return 0
    return math.sin(100 * x + 0.1) + x ** (-x) + 0.2
...
# best_x_binary, best_fitness_values_binary = evaluate_algorithm('threshold', 'binary')
# plot_progress(best_fitness_values_binary, 'Binary')

# best_x_gray, best_fitness_values_gray = evaluate_algorithm('threshold', 'gray')
# plot_progress(best_fitness_values_gray, 'Gray')

# best_x_binary, best_fitness_values_binary = evaluate_algorithm('roulette_wheel', 'binary')
# plot_progress(best_fitness_values_binary, 'Binary')

# best_x_gray, best_fitness_values_gray = evaluate_algorithm('roulette_wheel', 'gray')
# plot_progress(best_fitness_values_gray, 'Gray')
